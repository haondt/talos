...
namespace Talos.ImageUpdate.Repositories.Dockerfile.Services
{
    public class DockerfileFileService(IImageParser imageParser) : IRepositoryFileService
    {
        ...
        private DetailedResult<TalosSettings, string> ParseTalosLines(List<string> talosLines, string? shortFormValue)
        {
